...
--    cup_qty_per_box is the multiplier used by the Purchase API
--    to auto-compute product_pcs_qty on every purchase entry.
...
-- 2. Purchase
--    product_pcs_qty = product_box_qty × cup_qty_per_box (server-computed on new entries;
--    provided explicitly here so direct SQL inserts land correctly).
INSERT INTO duco_purchase (product_code, product_name, country_of_origin, product_box_qty, product_pcs_qty, date) VALUES
  ('DC-001', 'Paper Cup 200ml',   'China',   20, 1000, '2026-07-01'),  -- 20 × 50 = 1000
  ('DC-001', 'Paper Cup 200ml',   'China',   10,  500, '2026-07-10'),  -- 10 × 50 = 500
  ('DC-002', 'Paper Cup 350ml',   'Vietnam', 15,  600, '2026-07-05'),  -- 15 × 40 = 600
  ('DC-003', 'Plastic Cup 150ml', 'China',   25, 2500, '2026-07-08');  -- 25 × 100 = 2500

-- 3. Production
--    All three fields (cartons used, produced pcs, damage pcs) are entered manually.
...
-- 4. Sales
--    User now enters product_pcs_qty (pieces) directly — no box qty on new entries.
--    product_box_qty column still exists in the table (from prior migration) and defaults to 0.
INSERT INTO duco_sales (product_code, product_name, country_of_origin, product_pcs_qty, date) VALUES
  ('DC-001', 'Paper Cup 200ml',   'China',   200, '2026-07-05'),
  ('DC-001', 'Paper Cup 200ml',   'China',   300, '2026-07-15'),
  ('DC-002', 'Paper Cup 350ml',   'Vietnam', 200, '2026-07-09'),
  ('DC-003', 'Plastic Cup 150ml', 'China',   800, '2026-07-14');
...
-- DC-001:  (20+10) - (8+12)  = 30 - 20  = 10 cartons
-- DC-002:   15     -  10     = 5 cartons
-- DC-003:   25     -  15     = 10 cartons
--
