...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--app-bg)" }}>
      ...
      {/* Hero */}
      <section className="relative overflow-hidden border-b border-zinc-100 bg-grid py-20 md:py-28">
        <div className="mx-auto max-w-6xl px-6 text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-4 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-zinc-500 shadow-sm">
            Inventory Management Platform
          </div>
          <h1 className="mb-6 text-5xl font-bold tracking-tight text-zinc-950 md:text-6xl lg:text-7xl">
            Two companies.
            <br />
      ...
      <section className="border-y border-zinc-200 bg-white">
        <div className="mx-auto max-w-6xl px-6 py-12">
          <p className="mb-8 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-zinc-400">
            Platform features
          </p>
      ...
      <footer className="mx-auto max-w-6xl px-6 py-10 text-center">
        <p className="mb-4 text-[10px] font-bold uppercase tracking-[0.3em] text-zinc-400">Built with</p>
